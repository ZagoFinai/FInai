    ...
    return (
      <div className="relative bg-white rounded-3xl shadow-2xl p-6 sm:p-8 text-center overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <h3 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-3 sm:mb-4">Cadastro Realizado!</h3>
          <p className="text-gray-600 mb-4 sm:mb-6 text-base sm:text-lg leading-relaxed max-w-2xl mx-auto">
            Seu cadastro foi realizado com sucesso! 
            Em instantes você será redirecionado para o WhatsApp para ativar sua conta no FinAí.
          </p>
          
          <div className="bg-blue-50 border border-blue-200 rounded-xl p-3 sm:p-4 mb-4 sm:mb-6">
            <div className="flex items-center justify-center space-x-2 mb-2">
              <div className="text-xl sm:text-2xl">🎉</div>
              <span className="text-blue-800 font-bold text-base sm:text-lg">Cadastro Sincronizado!</span>
            </div>
            <p className="text-blue-700 text-sm">
              Seus dados já foram salvos automaticamente no painel administrativo
            </p>
          </div>
          ...
          <div className="bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-xl p-4 sm:p-6 mb-4 sm:mb-6">
            ...
            <div className="bg-white rounded-lg p-3 border border-green-200">
              ...
              <p className="text-green-700 text-xs mt-1">
                📞 Número: <strong>(51) 99409-3944</strong>
              </p>
            </div>
          </div>
    ...
    <div className="relative bg-white rounded-3xl shadow-2xl overflow-hidden">
      ...
      <div className="relative z-10 p-6 sm:p-8">
        <div className="text-center mb-6 sm:mb-8">
          ...
          <div className="inline-flex items-center bg-gradient-to-r from-green-100 to-emerald-100 rounded-xl px-4 py-3 sm:px-6 sm:py-3">
            ...
            <div>
              ...
              <p className="text-green-700 text-xs sm:text-sm">Comece a usar imediatamente</p>
            </div>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6 max-w-md mx-auto">
          ...
          <div className="bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-xl p-3 sm:p-4 mb-4 sm:mb-6">
            <div className="flex items-center space-x-3">
              <div className="text-xl sm:text-2xl">📱</div>
              <div>
                <p className="font-bold text-green-800 text-sm">Próximo Passo: WhatsApp</p>
                <p className="text-green-700 text-xs">
                  Após o cadastro, você será direcionado para o WhatsApp para ativar sua conta
                </p>
              </div>
            </div>
          </div>
          ...
          >
            {isSubmitting ? (
              ...
              <div className="flex items-center justify-center">
                ...
                <span>Cadastrar e Ir para WhatsApp</span>
              </div>
            )}
          </button>
        </form>
        ...
        <div className="mt-6 text-center">
          <div className="inline-flex items-center bg-blue-50 border border-blue-200 rounded-xl px-4 py-2">
            <MessageCircle className="w-4 h-4 text-blue-600 mr-2" />
            <span className="text-blue-700 text-xs">
              Número WhatsApp: <strong>(51) 99409-3944</strong>
            </span>
          </div>
        </div>
      </div>
